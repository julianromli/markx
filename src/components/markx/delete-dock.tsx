    ...
    >
      ...
      >
        <div
          ...
          className={cn(
            "flex items-center gap-2 rounded-full px-5 py-3 text-[13px] font-semibold leading-none",
            ...
            open &&
              armed &&
              "translate-y-0 scale-110 opacity-100 bg-[#e11d48] text-white shadow-[0_10px_32px_rgba(225,29,72,0.35)]",
            open &&
              !armed &&
              "bg-[rgba(32,32,32,0.88)] text-white shadow-[0_8px_28px_rgba(0,0,0,0.18),0_1px_0_rgba(255,255,255,0.12)_inset] backdrop-blur-xl"
          )}
        >
          <TrashIcon
            className={cn(
